...
public class TestURL extends JLabel implements MouseListener {
	...
	public static void main(String[] args) {
		...
		JLabel l = new TestURL("http://zhidao.baidu.com/question/130767272.html", "百度知道");
		f.add(l, "South");
		f.setSize(345, 123);
	...
	public TestURL(String ustr, String ttt) {
		this.ustr = ustr;
		this.setText(ustr);
